...
export default (await import('vue')).defineComponent({
    ...
    setup() {
        ...
        const resendActivationEmail = async () => {
            ...
            try {
                const response = await apiClient.post(RESEND_ACTIVATION_EMAIL_URL, { email: email.value });
...
function __VLS_template() {
    ...
    // @ts-ignore
    const __VLS_32 = __VLS_asFunctionalComponent(__VLS_31, new __VLS_31({ title: ("Resend Activation Email"), }));
    const __VLS_33 = __VLS_32({ title: ("Resend Activation Email"), }, ...__VLS_functionalComponentArgsRest(__VLS_32));
    ...
    let __VLS_67;
    const __VLS_68 = {
        onClick: (__VLS_ctx.resendActivationEmail)
    };
    let __VLS_64;
    let __VLS_65;
